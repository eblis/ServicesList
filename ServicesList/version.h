...
#ifndef M_SERVICESLIST_VERSION_H
#define M_SERVICESLIST_VERSION_H
...
#define __DESC                  "Tries to list all services available in Miranda."
#define __AUTHOR                "Cristian Libotean"
#define __AUTHOREMAIL           "eblis102@yahoo.com"
#define __COPYRIGHT             "© 2006-2009 Cristian Libotean"
#define __AUTHORWEB             "http://www.miranda-im.org/"

#if defined(WIN64) || defined(_WIN64)
#define __PLUGIN_DISPLAY_NAME   "Services list (x64)"
#else
#define __PLUGIN_DISPLAY_NAME   "Services list"
#endif

#endif //M_SERVICESLIST_VERSION_H
